<template>
  <div>
    <div style="margin-bottom: 5px">
      <el-input v-model="nameText" placeholder="请输入商品名" style="width: 200px;"
      ...
      <el-button @click="loadPost" size="small" type="primary" icon="el-icon-search" style="margin-left: 5px">查询</el-button>
      <el-button @click="reset" size="small" type="danger" icon="el-icon-delete">重置</el-button>
      <el-button @click="add" size="small" type="primary" icon="el-icon-plus" v-if="user.grade==0"></el-button>
    </div>
